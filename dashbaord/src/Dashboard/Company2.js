...
function Compnay2() {
    ...
    const handleSubmission =async () => {
      ...
      try {
        const response = await fetch('https://deltaserverer.onrender.com/company2', {
            method: 'POST',
            headers: {
  ...
  return (
    <div>
        <h1 className='text-center text-4xl mb-10'>Copany Expense Reklema</h1>
        <div>
