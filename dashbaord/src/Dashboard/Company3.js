...
function Compnay3() {
    ...
    const handleSubmission =async () => {
      ...
      try {
        const response = await fetch('https://deltaserverer.onrender.com/company3', {
            method: 'POST',
            headers: {
  ...
  return (
    <div>
        <h1 className='text-center text-4xl mb-10'>Copany Expense Buiro</h1>
        <div>
