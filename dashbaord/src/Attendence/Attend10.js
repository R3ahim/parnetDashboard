...
function Attend10() {
    ...
    const filteredPosts = posts?.filter(item => item.shopName === 'shop10@gmail.com'); 
    const filterJson = jsonData?.filter(item => item.email === 'shop10@gmail.com'); 
