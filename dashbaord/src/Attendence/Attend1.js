...
function Attend1() {
    ...
    const filteredPosts = posts?.filter(item => item.shopName === 'shop1@gmail.com'); 
    const filterJson = jsonData?.filter(item => item.email === 'shop1@gmail.com'); 
