...
function Attend4() {
    ...
    const filteredPosts = posts?.filter(item => item.shopName === 'shop4@gmail.com'); 
    const filterJson = jsonData?.filter(item => item.email === 'shop4@gmail.com'); 
