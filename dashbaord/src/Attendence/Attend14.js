...
function Attend14() {
    ...
    const filteredPosts = posts?.filter(item => item.shopName === 'shop14@gmail.com'); 
    const filterJson = jsonData?.filter(item => item.email === 'shop14@gmail.com'); 
